...
// we want to make limit to return specific number of returned data with limit(5) return just 5 items
// we want to return the newest products
// we want to sort depending on asc | desc | price
